...
import com.example.samuel.ugcc.fragments.AnnouncementsFragment;
import com.example.samuel.ugcc.fragments.BookSessionFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        changeFragment(R.id.nav_announcements);
        ...
        switch (id){
            case R.id.nav_announcements:
                ...
                if(announcementsFragment != null){
                    ...
                    fragmentTransaction.replace(R.id.main_layout, announcementsFragment).commit();
                }
                break;

            case R.id.nav_councelling_session:
                BookSessionFragment bookSessionFragment = new BookSessionFragment();
                if(bookSessionFragment != null){
                    fragmentTransaction = getSupportFragmentManager().beginTransaction();
                    fragmentTransaction.replace(R.id.main_layout, bookSessionFragment).commit();
                }
                break;

            case R.id.nav_about:
                CenterInfoFragment centerInfoFragment = new CenterInfoFragment();
                if(centerInfoFragment != null){
                    fragmentTransaction = getSupportFragmentManager().beginTransaction();
                    fragmentTransaction.replace(R.id.main_layout, centerInfoFragment).commit();
                }
                break;

            case R.id.nav_councelors:
                CouncelorsFragment councelorsFragment = new CouncelorsFragment();
                if(councelorsFragment != null){
                    fragmentTransaction = getSupportFragmentManager().beginTransaction();
